...
The materials used in this study as raw cartographic grids include the following datasets. The bathymetric mapping was based on the ETOPO Global Relief Model \cite{NOAA}; the gravity grids were derived from EGM-2008 \cite{Pavlis}.
