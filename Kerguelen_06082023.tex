...
The Kerguelen Plateau presents a large topographic elevation \hl{in south-west Indian Ocean }which extends on $6500 km^2$ \cite{Operto}\hl{, Figure }\ref{fig01}. The Kerguelen Archipelago formed on the plateau forms a shallow submarine plateau. On the northwest, the archipelago is limited by the Crozet Archipelago which is located 1250 km \cite{BRETON2013126}, to the north -- by the African-Antarctic Basins, to the northeast -- by the Australian-Antarctic Basin, and to the south -- by the Antarctic.
