...
The distribution of the sediment thickness correlates with the age of the underlying oceanic lithosphere and its latitude, which can be noted by the comparison of maps in Figure \ref{fig02} and Figure \ref{fig06}. Such correspondence is especially visible for higher values of the sediment thickness near the shorelines of Antarctic, Amery Ice Shelf (3000-4000 m), Enderby Land (over 4000 m) and the Kerguelen Plateau (2000-3000 m). Higher level of sediment thickness in these areas may also indicate earlier processes of the subaerial erosion which took place before the subsidence and associated sedimentation. 
