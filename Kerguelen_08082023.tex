...
The map of the geoid inundations is completed using the EGM96 dataset using the lines of code in a GMT script where each module defines certain features on a map. To make mapping process effective, the scripts are run from the console for the visualization of the geoid and adjusted accordingly to the target cartographic elements: projections, grids, colour palettes, raster extent and annotations, etc. To this end, these cartographic elements were also defined stepwise on the presented maps of geoid, as demonstrated in a script placed in the Appendix \ref{App} of this study in Listing \ref{lst11}. Such strategy of data visualization used in GMT ensures high automation of data processing which outperforms the conventional mapping tools.
