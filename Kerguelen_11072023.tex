...
The distribution of sediment thickness correlates with the age of the underlying oceanic lithosphere and its latitude as can be seen by comparison of maps in Figure \ref{fig02} and Figure \ref{fig06}, as especially visible in higher values of sediment thickness near the shorelines of Antarctic, Amery Ice Shelf (3000-4000 m), Enderby Land (over 4000 m) and Kerguelen Plateau (2000-3000 m).

%----------- subsection ----------->
\subsection{Free-air gravity anomaly and vertical gravity gradients}

Marine gravity field over the Kerguelen Plateau region and adjacent areas of the south-west Indian Ocean are shown in Figure \ref{fig07}. Vertical gravity gradient anomalies over Kerguelen Plateau region showing variations in gravity with the change in topographic elevations are visualised in Figure \ref{fig08}.
