...
Sediments covering the Kerguelen Plateau include pillow lavas, tuffaceous sediments and marine siltstones which were deposited since late Miocene \cite{Duncan}. The general orientation of maximal sedimentation areas is coherent to the sediment-filled troughs stretching in NW-SE-direction which are associated with general NW-SE orientation of Keguelen and axes of the tectonic faults.  
