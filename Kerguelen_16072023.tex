...
\begin{lstlisting}[language=bash,caption=Mapping crustal age uncertainty of the oceanic lithosphere in Kerguelen Plateau and SW Indian Ocean,style=mystyle,label={lst03}]
#!/bin/sh
