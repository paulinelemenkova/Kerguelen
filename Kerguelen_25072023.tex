...
In our approach, we combine the bathymetric and marine geophysical data on Kerguelen Plateau (Figure \ref{fig01}) in regional and local scales with varied level of details to describe the structures of the south-west Indian Ocean. 
...
The Kerguelen Plateau presents an extended  $6500 km^2$ large topographic elevation situated in the south-western sector of the Indian Ocean \cite{Operto}, Figure \ref{fig01}.  The origin of the Kerguelen Plateau is related to the hotspot associated with the the kinematics of Gondwana breakup in Cretaceous (ca. 120-110 Ma) and spreading between India and Antarctica in south-western segment of the current Indian Ocean \cite{Guglielmi}. Early surface expression of the Kerguelen Plume at the southern Kerguelen Plateau initiated in Mesozoic around 120 Ma \cite{Gaina}.
...
The materials used in this study as raw cartographic grids include the following datasets. The marine geological data regarding age, spreading rates, and asymmetry of the ocean crust were derived from the high-resolution dataset \cite{Mueller}, Figure \ref{fig03}. \hl{The dataset on spreading asymmetry is derived from the NOAA where units are expressed as \% of crustal accretion of the seafloor, i.e. symmetric spreading results in values of 50\% on conjugate ridge flanks.}
