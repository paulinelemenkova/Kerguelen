...
\hl{The visualised }marine gravity field over the Kerguelen Plateau region and \hl{the }adjacent areas of the south-west Indian Ocean are shown in Figure \ref{fig07}. 
...
\hl{Figure} \ref{fig08} \hl{shows the outputs of the mapping for vertical gradient over the Kerguelen and the southwest Indian Ocean where the effects of different locations are presented.} 
