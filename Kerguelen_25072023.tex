...
Marine gravity field over the Kerguelen Plateau region and adjacent areas of the south-west Indian Ocean are shown in Figure \ref{fig07}. The comparison of gravity roughness with map of the half-spreading rates (Figure \ref{fig04}) and sediment thickness (Figure \ref{fig06}) shows the relationship between the speed of the spreading of mid-ocean ridges and roughness of seafloor basement which is explained by the process of mid-ocean ridge formation.  Other factors includes the associated magma flows, spreading directions in Mesozoic and isochron orientations of age of the oceanic crust which affect current bathymetric and gravity patterns \cite{Whittaker}. Furthermore, the gravity highs on the Kerguelen Plateau and Heard Island correspond to the maximal bathymetric elevations and indicate the seamounts formed of Miocene basalts erupted during volcanic activity in the southern Indian Ocean and resulted in a large igneous province \cite{Weis}.
...
The anomaly of the magnetic intensity at an altitude of 5 km above mean sea level over Kerguelen \hl{Plateau }is shown in Figure \ref{fig09}. 
