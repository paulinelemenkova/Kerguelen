...
\pubyear{2023}
\copyrightyear{2023}
\externaleditor{{Giuseppe Masetti, Ian Church, Anand Hiroji, Ove Andersen} %MDPI: Please add academic editor if available. % Author's reply: I don't know Academic Editor.
...
\address [1]{%
Laboratory of Image Synthesis and Analysis, École polytechnique de Bruxelles, %MDPI: Please check if this part should be deleted. % Author's reply: yes, can be deleted (I deleted it).
...
%MDPI: some changes made in this paragraph. % Author's reply: yes, I agree and confirm.
...
\caption{Map %MDPI: Figures moved below first citations, please check and confirm. % Author's reply: yes, I agree and confirm.
%MDPI: Please revise date format if possible, e.g., 23 July 2023. Same in all figures below. % Author's reply: the date on the map is corrected as requested.
...
The materials used  as input cartographic grids include the following datasets. The~marine geological data on age, spreading rates, and~asymmetry of the ocean crust were derived from the NOAA high-resolution dataset~\cite{Mueller}, Figure~\ref{fig03}. The~units of the dataset on spreading asymmetry are expressed as \% of crustal accretion of the seafloor, i.e.,~symmetric spreading results in values of 50\% on conjugate ridge flanks. The~bathymetric mapping was based on the ETOPO Global Relief Model~\cite{NOAA}. The~gravity grids were obtained from the EGM-2008 and EGM96~\cite{Pavlis}. Gravity data are grounded on the concept of gravity anomaly across different Earth surfaces, which correlates with the interplay between topography, mass distribution within local and regional relief structures, marine gravity values, and the establishment of gravitational potential across various Earth locations. %MDPI: some changes made in this paragraph. % Author's reply: yes, I agree and confirm.

\begin{figure}[H]
\includegraphics[width=14 cm]{Fig_03.jpg}
\caption{Asymmetry in crustal accretion on conjugate ridge flanks of the ocean crust over the Kerguelen Plateau region, east Antarctic and south-west Indian Ocean. Map source: author. \label{fig03}} % Author's reply: the date on the map is corrected as requested in format "23 July 2023".
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=14 cm]{Fig_04.jpg}
\caption{Spreading %MDPI: Please check if ``yr'' should be replaced with ``year'' in the pucture. Same below. % Author's reply: yes, replaced with "year". Also, the date on the map is corrected as requested in format "23 July 2023".
...
\begin{figure}[H]
\hspace{-9pt}\includegraphics[width=14 cm]{Fig_05.jpg}
\caption{Age uncertainty in lithosphere crust (m.y) over the Kerguelen Plateau region, east Antarctic and south-west Indian Ocean. Cartography: GMT. Map source: author. \label{fig05}}
\end{figure} % Author's reply: yes, replaced with "year". Also, the date on the map is corrected as requested in format "23 July 2023".

\subsubsection{Mapping Sediment~Thickness}

A representation of the GlobSed 5-arc-minute total sediment thickness grid is extracted from the global raster grid on a target location of the Kerguelen Archipelago area and surrounding regions using 'grdcut' command, which selects the file. The~amplitude of values is checked using the Geospatial Data Abstraction Library (GDAL) library embedded in GMT using the 'gdalinfo'. Based on the range of the values, the~colour palette table is defined accordingly and presented using the 'psscale' module. This module is configured with parameters specifying the geographic location for each element on the map. The '-Dg' command is employed to define the position of the colour scale on the map using coordinates. Furthermore, grid annotations and graticules are added utilizing the 'psbasemap' GMT module. The remaining part of the script, complete with added comments for concise explanations, is outlined in Listing \ref{lst06} within the Appendix of this study. This particular listing was utilized to create the map featured in Figure~\ref{fig06}. %MDPI: some changes made in this paragraph. % Author's reply: yes, I agree and confirm.

\begin{figure}[H]
\includegraphics[width=14 cm]{Fig_06.jpg}
\caption{Sediment thickness (m) in East Antarctica, South-West Indian Ocean and the Kerguelen Plateau region. Cartography: GMT. Lambert azimuthal equal-area projection. Map source: author. \label{fig06}} % Author's reply: the date on the map is corrected as requested in format "23 July 2023".
\end{figure} 
...
%MDPI: these last three paragraphs split up from the original one % Author's reply: yes, I agree and confirm.
...
\begin{figure}[H]
\includegraphics[width=14 cm]{Fig_07.jpg}
...
\begin{figure}[H]
\includegraphics[width=14 cm]{Fig_08.jpg}
...
The correlations observed between sediment thickness (Figure \ref{fig06}) and the age of the oceanic lithosphere (Figure \ref{fig02}) demonstrate the role of ocean floor formation in influencing the pattern of distribution and accumulation of sediments.} %MDPI: some changes made in the last two paragraphs. % Author's reply: yes, I agree and confirm.
...
The anomaly of the magnetic intensity at an altitude of 5 km above mean sea level over the Kerguelen Plateau is shown in Figure~\ref{fig09}. 

\begin{figure}[H]
\includegraphics[width=14.0 cm]{Fig_09.jpg}
\caption{Patterns of the marine and terrestrial airborne magnetic anomaly over the Kerguelen Plateau on a three-minute resolution grid of WDMAM, south-west Indian Ocean. Map source: author. \label{fig09}}
\end{figure} % Author's reply: the date on the map is corrected as requested in format "23 July 2023".
...
\newblock {\em Bibliographie Cartographique des Iles Kerguelen/par Jacques
  Nougier}; Institut Geographique National: Paris, France, 1968; p. 55. %MDPI: Please confirm pagination. % Author's reply: yes, I confirm.
...
\newblock {Structure et Origine du Plateau de Kerguelen (Océan Indien
  ...
  Grand-Angle Marines}.
\newblock Ph.D. Thesis, Université Pierre et Marie Curie, %MDPI: Please check if this should be deleted. % Author's reply: yes, can be deleted (I deleted it).
  Paris, France,  1995.
...
\newblock {\em Geochem. Geophys. Geosyst.} {\bf 2005}, \emph{6},~1--28. % Author's reply: pagination is added.
...
\newblock {\em Fishes} {\bf 2023}, {\em 8}, 174. % Author's reply: yes, confirm.
...
\bibitem[Wessel et~al.(2013)Wessel, Luis, Uieda, Scharroo, Wobbe, Smith, Tian]{Wesseletal2023}
Wessel, P.; Luis, J. F.; Uieda, L.; Scharroo, R.; Wobbe, F.; Smith, W. H. F.; Tian, D.
\newblock The Generic Mapping Tools version 6.
\newblock Available online: https://www.generic-mapping-tools.org/ (accessed on 7 July 2023)
...
\newblock {\em Deep Sea Res. Part II Top. Stud. Oceanogr.} {\bf
  2008}, {\em 55},~880--892. {\url{https://doi.org/10.1016/j.dsr2.2007.12.039}}. % Author's reply: yes, can be deleted (I deleted it).
...
\newblock Slope currents around the Kerguelen Islands from demersal longline
  fishing records.
\newblock {\em Geophys. Res. Lett.} {\bf 2008}, \emph{35},~1--6. % Author's reply: pagination is added.
...
\newblock {\em Deep Sea Res. Part II Top. Stud. Oceanogr.} {\bf
  2007}, {\em 54},~1915--1929.  {\url{https://doi.org/10.1016/j.dsr2.2007.06.012}}.}
   % Author's reply: yes, can be deleted (I deleted it).
...
\newblock {\em Geophys. Res. Lett.} {\bf 2006}, \emph{33},~1--4. % Author's reply: pagination is added.
...
\newblock Age, spreading rates, and spreading asymmetry of the world's ocean
  crust.
\newblock {\em Geochem. Geophys. Geosyst.} {\bf 2008}, \emph{9},~1--19. % Author's reply: pagination is added.
...
\newblock NOAA National Centers for Environmental Information: Asheville, NC, USA, 2022. % Author's reply: yes, I confirm newly added information.
...
\newblock The development and evaluation of the Earth Gravitational Model 2008
  (EGM2008).
\newblock {\em J. Geophys. Res. Solid Earth} {\bf 2012}, \emph{117},~1--38. % Author's reply: pagination is added.
...
\newblock \emph{Geophys. Res. Abstr.} \textbf{2008}, \emph{10}, EGU2008-A-01891. %MDPI: Please confirm reference format and check if this part is necessary. % Author's reply: it can be deleted (I deleted it).
...
Condie, K.C.
\newblock The mantle. In {\em Earth as an Evolving Planetary System}, 4th ed.;  Condie, K.C., Ed.; Academic Press: Oxford, UK, 2022; Chapter 4, pp. 81--125. % Author's reply: yes, I confirm newly added information.
...
\newblock {\em Geochem. Geophys. Geosyst.} {\bf 2009}, \emph{10},~1--12. % Author's reply: pagination is added.
...
\newblock Height connection across sea by using satellite altimetry data sets,
  ...
  Gravity Model.
\newblock {\em Geod. Geodyn.} {\bf 2023}, \emph{14}, 347--354. \linebreak % Author's reply: yes, I confirm newly added information.
...
{\url{https://doi.org/10.1016/j.pss.2010.12.008}}. % Author's reply: yes, can be deleted (I deleted it).
...
\newblock In {\em Antarctica Oceanology II: The Australian–New Zealand
  Sector}; American Geophysical Union (AGU): Washington, DC, USA, 1978; pp. 165--196. % Author's reply: yes, I confirm newly added information.
...
\newblock {\em Geophys. Res. Lett.} {\bf 2010}, \emph{37},~1--5. % Author's reply: pagination is added.
...
\newblock {\url{https://doi.org/10.1016/0025-3227(77)90049-4}}. % Author's reply: yes, can be deleted (I deleted it).
...
\newblock {\em Geochem. Geophys. Geosyst.} {\bf 2007}, \emph{8},~1--8. % Author's reply: pagination is added.
...
\newblock Topography, the geoid, and compensation mechanisms for the southern
  Rocky Mountains.
\newblock {\em Geochem. Geophys. Geosyst.} {\bf 2011}, \emph{12},~1--18. % Author's reply: pagination is added.
