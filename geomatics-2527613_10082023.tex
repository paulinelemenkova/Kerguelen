...
\address [1]{%
Laboratory of Image Synthesis and Analysis (LISA), École polytechnique de Bruxelles \hl{(Brussels Faculty of Engineering}%MDPI: Please check if this part should be deleted.
...
\newblock Cartographic Data Display. In {\em Geographic Information
  ...
  Cartography Series; Academic Press: \hl{Cambridge, MA, USA,} %newly added information, please confirm
...
\newblock Perspectives on Visualization and Modern Cartography. In
  ...
  Eds.; Modern Cartography Series; Academic Press:  \hl{Cambridge, MA, USA,} 1994; Chapter 17, Volume 2, pp. 333--341.
\newblock {\url{https://doi.org/10.1016/B978-0-08-042415-6.50024-7}}.
...
\newblock {\em Python for ArcGIS Pro: Automate Cartography and Data Analysis
  Using ArcPy, ArcGIS API for Python, Notebooks, and Pandas}; Packt Publishing: \hl{Birmingham, UK}, 2022.
...
\newblock In Proceedings of the 2012 IEEE Symposium on Visual Languages and
  Human-Centric Computing (VL/HCC), \hl{Innsbruck, Austria, 30 September--4 October} 2012; pp. 245--246.
...
\newblock {\em J. Imaging} {\bf 2022}, {\em 8}, \hl{317}.
...
\newblock {\em Appl. Sci.} {\bf 2022}, {\em 12}, \hl{12554}.
...
\newblock An integrated study of microstructural, geochemical, and seismic
  ...
  Ocean).
\newblock {\em Geochem. Geophys. Geosyst.} {\bf 2008}, \emph{\hl{9} %MDPI: Please add pagination if available. Same in all highlighted references below.
}.
...
\newblock Satellite gravimetry and isostasy. In {\em Satellite
  Gravimetry and the Solid Earth}; Eshagh, M., Ed.; Elsevier: \hl{Amsterdam, The~Netherlands,} %newly added information, please confirm
  2021; Chapter 7, pp.
  313--373.
...
\newblock {\url{https://doi.org/10.1016/j.tecto.2013.01.006}}. \hl{TOPO-EUROPE III.} %MDPI: Please check if this should be deleted.
...
\newblock \emph{\hl{Proc}%MDPI: Formatted as a journal, please confirm.
...
\newblock {\url{https://doi.org/10.1016/j.marpetgeo.2009.08.011}}. \hl{The link between shallow and deep processes in sedimentary basins.} %MDPI: Please check if this should be deleted or formatted as a new reference. Same below.
...
\newblock Cartographic Data Capture and Storage. In {\em Geographic
  Information Systems}; Taylor, F., Ed.; Modern Cartography Series; Academic Press:  \hl{Cambridge, MA, USA,} %newly added information, please confirm
...
\newblock {\em J. Geophys. Res. Ocean.} {\bf 2011}, \emph{\hl{116}}.
...
\newblock  {\url{https://doi.org/10.1016/j.tecto.2004.01.008}}. \hl{Tectonics, Seismicity and Crustal Structure of the Ontong Java
  Plateau: Solomon Island Arc Convergent Zone, Southwest Pacific Ocean.}
...
\newblock {\em Bibliographie Cartographique des Iles Kerguelen/par Jacques
 ...
 Available online:  \url{https://catalogue.nla.gov.au/Record/2259953}  (\hl{accessed on}). %MDPI: Please add access date.
